...
public class Main {
    public static void main(String[] args) {
        ...
        String str1 = dltAllBrckts(str);
        System.out.println(str1);
        System.out.println();

        String str2 = dltNmbrs(str);
        System.out.println(str2);
        System.out.println();

        String str3 = dltZrs(str);
    ...
    static String dltAllBrckts(String str) {
        String res = "";
    ...
    static String dltNmbrs(String str) {
    ...
    static String dltZrs(String str) {
        String res = "";
        String[] mas = str.split("\\D+");
